...
jolteon_path = Path('/home/jacob/PhD/Projects/jolteon_model/Data/JOLTEON')
out_path = Path('/home/jacob/PhD/Projects/jolteon_model/Data')

out_name_prefix = "jolteon"
detection_limit = 5.
...
np.savez(
    out_path / f"{out_name_prefix}_train_statistics.npz",
    statistics
)
...
with h5py.File(out_path / f"{out_name_prefix}_train.h5", "a") as h5file:
...
with h5py.File(out_path / f"{out_name_prefix}_val.h5", "a") as h5file:
